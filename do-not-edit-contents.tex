...
When team code ownership emerged as a core category, the researcher collected additional sampling in order to identify which practices fostered team code ownership. Constant comparison allowed the researcher to identify \quotes{the conceptual relationship between categories and their properties as they emerged} \cite{Glaser1992.} Asking the question \quotes{What is the goal of this practice with respect to team code ownership?} allowed us to differentiate two types of practices. Some practices were actively removing knowledge silos while the remainder were technical practices responsible for making it easy for any pair to be able to modify the code base. For example, Continuous Pair Programming and Overlapping Pair Rotation both help remove knowledge silos. The researcher collected data until saturating the core category.
...
Pivotal Lab's mission is not only to deliver highly-crafted software products, but also to provide a transformative experience for their clients' engineering cultures. To change a developer's way of working, Pivotal combines the client's software engineers with Pivotal's engineers at a Pivotal office where they can experience Extreme Programming in an environment conducive to agile development. This experience is similar to the creation of the New United Motor Manufacturing (NUMMI) plant where General Motors sent workers to Japan to learn Toyota's Production System \cite{ShookNummi}. For startups, Pivotal engineers might be the first to work on the project. For enterprise clients, Pivotal provides additional engineering resources to accomplish new business goals. 

The primary researcher observed only teams in Pivotal Labs. Teams in other divisions follow different software practices.

The ability to pair program is a strong pre-requisite for becoming a Pivotal Labs developer. The first round interview is scripted to see how well the candidate listens to their pair and attempts to observe empathy in the candidate. Multiple pair-programming sessions are performed during job interviews, minimizing the risk of running into pair programming problems later on. 
...
\begin{figure*}[t]
\centering
\includegraphics[width=7.1in]{OriginalDeveloperStaffingV3.jpg}
...
On this project, developers were routinely rotated on and off and were replaced for a variety of reasons, including being promoted to management, taking medical leave, leaving the company, transferring to a different office, transferring to another project, and taking vacations. In addition, some developers were added to the project to increase development speed.
...
Sustainable software development is the ability for a team to continue to deliver features despite team disruptions. A team with high development sustainability is able to “turn the crank” and routinely deliver new features.
...
The primary concern of Sustainable Software Development is enabling any software development pair to be able to work on any story in the backlog. The principles encourage a positive attitude towards team disruption, knowledge sharing and continuity, as well as caring about code quality. The goal of any pair picking up any story is achieved by actively removing knowledge silos and caretaking the code. 
