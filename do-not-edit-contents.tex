...
\textbf{Purpose:} Everyone is responsible for the the whole system. An organization saying, \quotes{Anyone can modify any piece the code} is not sufficient to achieve the desired result of collective code ownership. Achieving collective code ownership requires a set of enabling practices. These enabling practices aim at removing knowledge silos and taking good care of the code, as described in the following sections.
...
When the team says \quotes{Marion really knows the Apple watch code base, we need her on that story,} or \quotes{Shea knows the ins-and-outs of the legacy integration, we need him to work on this,} these are signs that knowledge silos have emerged. 
