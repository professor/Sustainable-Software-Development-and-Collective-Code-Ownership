...
$\bullet$ Team Code Ownership & $\bullet$ Continuous Pair Programming         & $\bullet$  TDD / BDD                   \\
...
\textbf{Description:} Team code ownership conveys that any developer on the team can improve any part of the system at any time \cite{ExtremeProgramming2004}. 
...
\label{Transitioning}
Since Sustainable Software Development requires a shift from individual ownership to team ownership, the transition should not be taken lightly. 

The developer changes from the role of owner to the role of steward or caretaker. In one interview, a software engineer was struggling to describe his relationship with the code on a very challenging project and settled in on the caretaker metaphor: \quotes{Sometimes I kind of feel like a janitor to [the code base].  Maybe caretaker would be better. Yeah, probably caretaker. I feel like a janitor just cleans up messes, but a caretaker makes things better.}

Some developers make the transition to team code ownership easily. They immediately see the benefits of being able to modify any part of the code base and quickly shift from \quotes{I made this} (individual ownership) to \quotes{we made this} (team ownership.)

Some developers struggle adjusting to team code ownership as they miss having a piece of code or functionality that they exclusively developed and hence could be recognized as their own. Some people derive their sense of value, worth, and identity, from what they produce. The transition requires people to change their relationship with what they produce and shift how they value and perceive themselves. 
...
The engineer learned the rhythm of story rotation and developed trust in his team: the rest of the team will do a good job. Developers rolling off a story in flight can look in anticipation to see how the next pair solved the problem. 
...
When a team achieves a sense of team code ownership, the magic happens: \quotes{People are a lot more flexible all across the board, with changing things or accepting feedback or collaborating,} and \quotes{We want the best possible product that’s best for users \ldots we just want the best thing out there.} Then the team can say \quotes{Hey, this is our code!}
