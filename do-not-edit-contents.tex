...
\textif(Optimizing for context sharing:} A few teams are experimenting with rotating onto a track the last person to work on that track. The goal each day is for the developer leaving the track next to empower the developer joining the track. When the rotation happens the next day, the second developer is asked, \quotes{Was enough context shared with you?} If the answer is no, then the pair continues to work together. This provides a feedback loop on how well the team is transferring knowledge.  

A few teams are experimenting with rotating onto a track the person who has not been working on the track for the longest t. 
The goal each day is for the developer leaving the track next to empower the developer remaining on the track. Before any rotation, the remaining developer is asked, \quotes{Was enough context shared with you?} If the answer is no, then the developer does not leave and the pair continues to work together for another day. This provides a feedback loop on how well the team is transferring knowledge. 
