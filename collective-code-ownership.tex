...
\textif{Context:} Conventional wisdom says that team churn is very disruptive for a team and should be avoided. However, Pivotal projects succeed despite high team churn.  
...
\textif{Results:} This paper introduces the Theory of Sustainable Software Development and its principles, policies, and practices. The practices both remove knowledge silos and caretake the code. The practices both remove knowledge silos and improve the code for pair rotation by caretaking. 

\textif{Limitations:} While the results are highly relevant to Pivotal, the outcomes may not be transferable to other software development organizations with different software development cultures.
