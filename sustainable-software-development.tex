...
\textit{Context:} Conventional wisdom says that team churn is very disruptive for a team and should be avoided. However, Pivotal projects succeed despite high team churn.  
...
\textit{Results:} This paper introduces the Theory of Sustainable Software Development and its principles, policies, and practices. The practices both remove knowledge silos and caretake the code. The practices both remove knowledge silos and improve the code for pair rotation by caretaking. 
...
\textit{Conclusion:}  The primary benefit to the employer is business agility. The engineering team continues to deliver software week after week, month after month, and survive disruptive events.  The primary benefit to the engineer team is the ability to work on every story, to understand the entire system, and provide teaching opportunities to share one's expertise and to deeper learn subtle parts of the technologies.  Software development continues regardless of changes in team composition.
\end{abstract}
